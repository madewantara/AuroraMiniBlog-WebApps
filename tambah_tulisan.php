...
?>
    <?php 
        ...
        $idpenulis=$_GET['id'];
        $query_a = " SELECT * FROM penulis WHERE idpenulis='".$idpenulis."' ";
        ...
        if(isset($_POST["submit"])){
            ...
            $image = addslashes(file_get_contents($_FILES['img']['tmp_name']));   
            if ($image==''){
                $error_img = "Mohon upload gambar dulu";

            }
        date_default_timezone_set('Asia/Jakarta');
        $timezone = date("Y-m-d");
        $query="INSERT INTO post (judul,isi_post,tgl_insert,tgl_update,idpenulis,idkategori,file_gambar) VALUES ('".$judul."','".$isi."','". $timezone ."','-','".$idpenulis."','".$kategori."','".$image."')";
...
<?php include('templates/header.php');?>
    <title>Tambah Tulisan-Aurora</title>
</head>
<body>
                ...
                <div class="card-body">
                    <form method="POST" autocomplete="on" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="isi" id="isi" rows="5"><?php if (isset($isi)) echo $isi;?></textarea>
